...
def create_pubtator_mcp(profile: MCPToolProfile | str | None = None) -> FastMCP:
    ...
    mcp = FastMCP(
        ...
        instructions=(
            ...
            "pubtator_get_server_capabilities. For grounded answers use "
            "pubtator_ground_question; for explicit control use "
            ...
            "filters. If index_review_evidence is unavailable, call pubtator_diagnostics "
            "and fall back to pubtator_get_publication_passages with the same PMIDs. "
