...
from .entities import TextAnnotation, EntityRelation
...
class AnnotatedPublication(BaseModel):
    ...
    passages: List[TextPassage] = Field(
        default_factory=list, description="Text passages"
    )
...
class BioC_Document(BaseModel):
    ...
    passages: List[Dict[str, Any]] = Field(
        default_factory=list, description="Document passages"
    )
    annotations: List[Dict[str, Any]] = Field(
        default_factory=list, description="Document annotations"
    )
    relations: List[Dict[str, Any]] = Field(
        default_factory=list, description="Document relations"
    )
...
class ExportFormat(BaseModel):
    ...
    supports_full_text: bool = Field(
        default=False, description="Supports full text export"
    )
