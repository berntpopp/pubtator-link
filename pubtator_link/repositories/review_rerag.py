...
from pubtator_link.repositories.review_research_session_repository import (
    ReviewResearchSessionRepositoryMixin,
)
...
class ReviewReragRepository(Protocol):
    ...
    async def list_research_session_summaries(
        ...
        *,
        ...
        """List a candidate-free page of staged research-session summaries."""
...
class PostgresReviewReragRepository(ReviewResearchSessionRepositoryMixin):
